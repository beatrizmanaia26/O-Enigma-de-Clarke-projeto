...
public class SistemaProgresso : MonoBehaviour
{
    ...
    public void RestaurarEstado()
    {
        ...
        if (jogador != null)
        {
            ...
            // Player usado na fase real
            var playerFase2Real = jogador.GetComponent<PlayerFase2Real>();

            if (playerFase2Real != null)
            {
                playerFase2Real.SetPosition(estado.posicaoJogador);
                playerFase2Real.VidasRestantes = (int)estado.vidaJogador;

                Debug.Log($"PlayerFase2Real restaurado. Posição: {estado.posicaoJogador}, Vidas: {estado.vidaJogador}");
            }
