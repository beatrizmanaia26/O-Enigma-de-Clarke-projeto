using UnityEngine;
using UnityEngine.SceneManagement;   // ← Adicione essa linha no topo
...
public class PlayerFase2 : MonoBehaviour
{
    ...
    [Header("Derrota")]                      // NOVO
    public string nomeCenaDerrota = "TelaDerrota";   // Nome exato da cena de derrota
    ...
    void Morrer()
    {
        ...
        // Carrega a cena de derrota (como no script Player)
